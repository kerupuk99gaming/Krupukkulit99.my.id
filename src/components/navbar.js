        ...
        <div className="flex items-center justify-between h-16">
          <div className="w-full justify-between flex items-center">
            <a
              ...
              href="/"
            >
              <span className="text-gradient bg-gradient-to-r from-yellow to-yellow font-semibold">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-center space-x-4">
                <Link
                  className="relative after:rounded after:bg-yellow after:absolute after:h-0.5 after:w-0 after:bottom-0 after:left-0 hover:after:w-full after:transition-all after:duration-300 text-black opacity-70 hover:opacity-100 px-3 py-2 rounded-md text-sm font-medium font-montserrat"
                  to="/"
                >
                  Utama
                </Link>
                ...
                <div className="items-center">
                  <a
                    href="https://wa.me/6281293455225"
                    className="transition-all duration-500ms ease-in-out hover:ease-in-out bg-transparent mt-5 py-2.5 px-4 text-base font-medium text-center text-black rounded-lg border border-yellow hover:text-white border-black  hover:bg-yellow"
                  >
