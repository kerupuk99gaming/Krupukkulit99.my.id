...
const BlogsContainer = ({ data }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto mt-10 px-8 text-black">
      ...
      <div className="w-auto p-8 m-4 h-72 sm:h-96 xs:h-96 xxs:h-96 mt-10 bg-yellow bg-gradient-to-r from-yellow to-yellow rounded-xl flex flex-col items-center justify-center">
