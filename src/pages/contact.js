...
import image from "../images/kerupuk-rame.jpg"
  ...
  return (
    <Layout>
      ...
      <div className="max-w-7xl mx-auto mt-10 flex text-black xxs:flex-col sm:flex-row">
        <Fade duration={1200}>
          <div className="bg-yellow opacity-70 p-10 rounded-xl w-3/4 m-5 w-auto">
            ...
            <p className="text-lg mt-2 opacity-70 w-3/4 xxs:text-xs xxs:w-full sm:text-sm sm:w-3/4">
              ...
              siap melayani Anda dengan produk kerupuk kulit sapi asli yang gurih,
              renyah, sehat, dan halal.
            </p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-2 grow">
                      ...
                      <p className="text-neutral-500 mb-2">
                        <a href="https://wa.me/6281293455225">0812-9345-5225</a>
                      </p>
                    </div>
                  </div>
                </div>
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-3">
                  <div className="flex items-start">
                    ...
                    <div className="ml-2 grow">
                      ...
                      <p className="text-neutral-500 mb-2">
                        <a href="mailto:kerupuk99gaming@gmail.com">
                          kerupuk99gaming@gmail.com
                        </a>
                      </p>
                    </div>
                  </div>
                ...
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-3">
                  <div className="align-start flex">
                    ...
                    <div className="ml-2 grow">
                      ...
                      <p className="text-neutral-500 mb-2">
                        <a
                          href="https://maps.app.goo.gl/ZspT5B4wDfRDGHdy5"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="underline text-blue-600 hover:text-blue-800"
                        >
                          Toko Kami (Klik untuk buka di Google Maps)
                        </a>
                      </p>
                    </div>
                  </div>
